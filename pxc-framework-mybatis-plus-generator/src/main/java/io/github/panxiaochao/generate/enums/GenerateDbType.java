...
public enum GenerateDbType {
     ...
     * ORACLE
     */
    ORACLE("oracle", new OracleQuery(), new OracleTypeConvert(), new MySqlKeyWordsHandler(), "Oracle11g及以下数据库(高版本推荐使用ORACLE_NEW)"),
    /**
     * DB2
     */
     ...
     * SQLSERVER2005
     */
    SQL_SERVER2005("sqlserver2005", new SqlServerQuery(), new SqlServerTypeConvert(), new MySqlKeyWordsHandler(), "SQLServer2005数据库"),
    /**
     * SQLSERVER
     */
    SQL_SERVER("sqlserver", new SqlServerQuery(), new SqlServerTypeConvert(), new MySqlKeyWordsHandler(), "SQLServer数据库");
    ...
    public static final Map<String, GenerateDbType> GENERATE_DB_TYPE_MAP =
            Arrays.stream(GenerateDbType.values()).collect(Collectors.toMap(GenerateDbType::getDbName, Function.identity()));
