...
public final class DataOfSize implements Comparable<DataOfSize>, Serializable {
  ...
  /**
   * Obtain a {@link DataOfSize} from a text string such as {@code 12MB} using the specified default
   * {@link DataOfUnit} if no unit is specified.
   * <p>
   * The string starts with a number followed optionally by a unit matching one of the supported
   * {@linkplain DataOfUnit suffixes}.
   * <p>
   * Examples: <pre>
   * "12KB" -- parses as "12 kilobytes"
   * "5MB"  -- parses as "5 megabytes"
