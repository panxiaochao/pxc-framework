...
public class ThreadPoolAutoConfiguration {
    ...
    // @ConditionalOnProperty(prefix = "spring.pxc-framework.thread-pool", name = "enabled", havingValue = "true")
     ...
     */
    @Bean
    // @ConditionalOnProperty(prefix = "spring.pxc-framework.task-scheduler", name = "enabled", havingValue = "true")
