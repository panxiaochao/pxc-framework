...
import io.github.panxiaochao.common.enums.ArgumentResponseEnum;
import io.github.panxiaochao.common.enums.CommonResponseEnum;
import io.github.panxiaochao.common.exception.BaseException;
import io.github.panxiaochao.common.exception.BaseRuntimeException;
import io.github.panxiaochao.common.exception.ext.ApiServerException;
...
public class RestExceptionHandler {
    ...
    private R<String> wrapperBindingResult(BindingResult bindingResult) {
        ...
        return R.fail(ArgumentResponseEnum.VALID_ERROR.getCode(), msg.substring(2), null);
    }
}
