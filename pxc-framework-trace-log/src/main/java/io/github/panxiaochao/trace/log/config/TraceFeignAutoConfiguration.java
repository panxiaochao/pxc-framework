...
import io.github.panxiaochao.trace.log.interceptor.feign.TraceFeignInterceptor;
...
public class TraceFeignAutoConfiguration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TraceFeignAutoConfiguration.class);
