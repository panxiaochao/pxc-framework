 ...
 */
package io.github.panxiaochao.trace.log.interceptor.httpclient;
 ...
 * <p> description: HttpClient5 Interceptor
 *
 * @author Lypxc
 * @since 2023-01-11
 */
public class TraceHttpClient5Interceptor implements HttpRequestInterceptor {

    private static final Logger LOGGER = LoggerFactory.getLogger(TraceHttpClient5Interceptor.class);
