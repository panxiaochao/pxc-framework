...
public class Redisson3AutoConfiguration {
     ...
     */
    @Bean
    public RedissonAutoConfigurationCustomizer redissonAutoConfigurationCustomizers(ObjectProvider<ObjectMapper> objectMapperObjectProvider) {
