...
import io.github.panxiaochao.common.builder.page.PageObjectResponse;
import io.github.panxiaochao.common.builder.page.Pagination;
...
public class RPageObject<T> {
    ...
    public static <T> RPageObject<T> ok(Pagination pagination, T data) {
        return new RPageObject<>(CommonResponseEnum.OK.getCode(), CommonResponseEnum.OK.getMessage(), new PageObjectResponse<>(pagination, data));
    }
