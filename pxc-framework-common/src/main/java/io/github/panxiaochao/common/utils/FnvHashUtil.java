...
public final class FnvHashUtil {
    ...
    public static long hashCode64(String name) {
        ...
        if (quote) {
            return FnvHashUtil.hashCode64(name, 1, len - 1);
        } else {
            return FnvHashUtil.hashCode64(name, 0, len);
        }
    }
    ...
    public static long hashCode64(long basic, String name) {
        ...
        if (quote) {
            ...
            return FnvHashUtil.hashCode64(basic, name, offset, end);
        } else {
            return FnvHashUtil.hashCode64(basic, name, 0, len);
        }
    }
