 ...
 */
package io.github.panxiaochao.common.unit;
...
public final class DataOfSize implements Comparable<DataOfSize>, Serializable {
    ...
    /**
     * Obtain a {@link DataOfSize} representing an amount in the specified {@link DataOfUnit}.
     *
    ...
    /**
     * Obtain a {@link DataOfSize} from a text string such as {@code 12MB} using
     * the specified default {@link DataOfUnit} if no unit is specified.
     * <p>
    ...
    public static DataOfSize parse(CharSequence text, DataOfUnit defaultUnit) {
        ...
        try {
            Matcher matcher = DataOfSize.DataSizeUtils.PATTERN.matcher(StringUtils.trimAllWhitespace(text));
            Assert.state(matcher.matches(), "Does not match data size pattern");
            DataOfUnit unit = DataOfSize.DataSizeUtils.determineDataOfUnit(matcher.group(2), defaultUnit);
