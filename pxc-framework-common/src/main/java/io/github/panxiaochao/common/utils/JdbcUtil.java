 ...
 * @since 2023-06-15
 */
public class JdbcUtil implements JdbcConstant {
    ...
    static {
        ...
        //         for (Enumeration<URL> e = ctxClassLoader.getResources("META-INF/db-driver.properties"); e.hasMoreElements(); ) {
        ...
        //     }
        // } catch (Exception e) {
        //     LOG.error("load db-driver.properties error", e);
        // }
    }
    ...
    public static String getDriverClassName(String rawUrl) throws SQLException {
        ...
        if (rawUrl.startsWith("jdbc:derby:")) {
            ...
            if (mysql_driver_version_6 == null) {
                mysql_driver_version_6 = ResourceUtil.loadClass("com.mysql.cj.jdbc.Driver") != null;
            }
