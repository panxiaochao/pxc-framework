...
import io.github.panxiaochao.common.builder.page.PageResponse;
...
public class RPage<T> {
    ...
    public static <T> RPage<T> ok(Pagination pagination, List<T> data) {
        return new RPage<>(CommonResponseEnum.OK.getCode(), CommonResponseEnum.OK.getMessage(), new PageResponse<>(pagination, data));
    }
